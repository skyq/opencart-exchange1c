 ...
 * Date: 22.03.2017
 */
$_['heading_title']    = '1c обмен';

// Text
$_['text_success']	    = 'Настройки обмена успешно обновлены!';
$_['text_edit']         = 'Редактирование обмена';
$_['text_extension']    = 'Обмен';
$_['text_ok']           = 'Загрузка завершенна успешно!';


// Error
$_['error_permission']  = 'У вас нет прав для управления этим модулем!';
$_['error_upload']      = 'Проблемы с загрузкой файла!';


$_['text_no_orders_support_alert']  = 'Обмен с заказами пока не поддерживается.';
$_['text_tab_general']		    = 'Основное';
$_['text_tab_update_fields']	= 'Обновляемые поля';
$_['text_update_fields_general']	    = 'Обновляемые основные поля';
$_['text_update_fields_description']	= 'Обновляемые поля описания';
$_['text_update_fields_alert']	        = '  Если продукт создается заново, или стоят галочки "Сбрасывать товары" и т.д., то эта настройка не актуальна.';
...
$_['text_upload_error_old']	= 'Что-то пошло не так. Загляните в &laquo;Система &rarr; Инструменты &rarr; Журнал ошибок&raquo;';
$_['text_upload_error']		= 'Что-то пошло не так.';
...
// Entry
$_['entry_stock_status_helper']	= 'Статус, показываемый, когда товара нет на складе';
$_['entry_stock_status']	= 'Отсутствие на складе:';
$_['entry_username']		= 'Логин:';
$_['entry_password']		= 'Пароль:';
$_['entry_status']		    = 'Статус:';
$_['entry_allow_ip']		= 'Разрешенные IP адреса:';
$_['help_allow_ip']		    = 'Разделять переносом строки. Если пусто, разрешены все адреса.';
...
$_['entry_root_category_is_catalog']	= 'Корневая категория - каталог:';
$_['help_entry_root_category_is_catalog']	= 'Все группы внутри каталога будут помещенны в группу с его именем';
...
$_['entry_fill_parent_cats']	= 'Показывать в родительских категориях:';
$_['entry_seo_url']		        = 'Генерировать SEO URL:';
$_['help_entry_seo_url']		= 'Через транслит имени';
